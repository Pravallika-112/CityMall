...
<div class = 'box'>  
    <?php
        ...
        $sql="insert into showbooking(name,phoneNo,noOfSeats,emailId)values('$fullname','$phoneNo','$noOfSeats','$emailId');";
        ...
        if(!$a){
            ...
            echo "<a href='viewticketbooking.php?fn=$fullname&ph=$phoneNo&s=$noOfSeats&em=$emailId'>
